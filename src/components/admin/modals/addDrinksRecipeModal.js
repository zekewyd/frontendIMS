...
import "./addDrinksRecipeModal.css";
...
function AddDrinksRecipeModal({ onClose, onSubmit }) {
    // Form state
    ...
    const handleSubmit = async (e) => {
        ...
        if (selectedIngredients.length === 0) {
            ...
            const invalidIngredient = selectedIngredients.some(
                (ing) => !ing.ingredientId || !ing.amount || !ing.units
            );
            ...
            <div className="add-recipe-modal-container">
                ...
                <form className="add-recipe-modal-form" onSubmit={handleSubmit}>
                    <div className="add-recipe-form-row">
                        <div className="add-recipe-modal-form-group">
                            <label htmlFor="recipeName">Recipe Name <span className="add-recipe-required">*</span></label>
                            <input
                                id="recipeName"
                                type="text"
                                value={recipeName}
                                ...
                                className={errors.recipeName ? "add-recipe-error" : "add-recipe-modal-input"}
                    ...
                    <div className="add-recipe-section">
                        ...
                        {selectedIngredients.map((ingredient, index) => (
                            <div key={index} className="add-recipe-ingredient-row">
                                ...
                                <div className="add-recipe-units">
                                    <select
                    ...
                    <div className="add-recipe-form-group">
                        <label>
                            ...
                            <textarea
                                ...
                                className={errors.description ? "add-recipe-error" : "add-recipe-modal-textarea"}
...
export default AddDrinksRecipeModal;